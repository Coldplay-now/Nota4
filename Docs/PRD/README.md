...
| 文档 | 描述 | 更新日期 |
|------|------|---------|
| [NOTA4_PRD.md](./NOTA4_PRD.md) | 产品需求文档 (主文档) | 2025-11-19 |
...
- 🎯 目标用户和需求分析
- ✨ 核心功能清单 (v1.1.1 已实现功能)
  - 基础功能：笔记编辑、实时预览、自动保存、笔记列表、侧边栏、标签系统、全文搜索
  - 增强功能：编辑器搜索、图片管理、主题系统、布局系统、编辑器设置
  - 导出功能：HTML/PDF/PNG 导出
- 🗺️ 开发路线图 (v1.0.0 - v1.2.0)
- 🏗️ 技术架构简述
- 🔍 竞品分析
- 📊 成功指标
